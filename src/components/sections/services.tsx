          ...
          {services.map((s, i) => {
            ...
            return (
              <motion.article
                ...
                className={`group relative flex flex-col overflow-hidden rounded-3xl border bg-[var(--card-bg)] shadow-[var(--card-shadow)] transition-colors ${
                  expanded
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-6">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <span className="shrink-0 rounded-full border border-[var(--glass-border)] bg-[var(--section-bg)] px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-[var(--muted)]">
                      Explore
                    </span>
                  </div>
                  ...
                  <button
                    ...
                    className="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-[var(--foreground)] transition hover:text-[var(--accent)]"
